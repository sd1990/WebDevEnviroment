...
public final class SecurityUtil {
    ...
    public static String SHA1Encode(String data, String key) {
        ...
        SecretKey secretKey = new SecretKeySpec(keyData, ALGORITHM_SHA1);
        try {
            ...
            // 完成 Mac 操作
            return TranscodeUtil.byteArrayToBase64Str(encode);
        }
     ...
     * @return 返回本地密钥
     */
    public static SecretKey getDHSecretKey(String publicKey, String privateKey) {
        try {
            // 初始化公钥
